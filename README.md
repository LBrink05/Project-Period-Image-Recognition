...
We have 2 Images angled left and right of the conveyor belt (768x768 pixels, RGBA) which will be saved in seperate folders called CAMERA_N where N is the index of the camera (here 0 to 1). The images themselves will be named in the scheme `VideoId_CameraId_FrameId_FOAM_{CLASSIFICATION}_IMPURITIES_{CLASSIFICATION}`. 
